...
?>
<p style="font-size:20px">近来卧室温湿度变化</p>
<script>
function changesrc(){
...
{
	$sql3 = "UPDATE control SET bed_con='1' WHERE 1";
	mysql_query($sql3);
}else
{
	$sql4 = "UPDATE control SET bed_con='0' WHERE 1 ";
	mysql_query($sql4);
}
...
if($row[0]==0)
{
	echo"<p style='font-size:20px;'>窗帘已合上</p>";
}else
{echo"<p style='font-size:20px;'>窗帘已拉起</p>";
}
?>
</center>
</body>
